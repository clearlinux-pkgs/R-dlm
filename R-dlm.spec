...
Version  : 1.1.4
Release  : 3
URL      : https://cran.r-project.org/src/contrib/dlm_1.1-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dlm_1.1-4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521211784
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library dlm|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/dlm/libs/symbols.rds
